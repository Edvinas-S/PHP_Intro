...
$products = $entityManager->getRepository('Product')->findBy(array('name' => 'DOPE'));
...
$products = $entityManager->getRepository('Product')->findBy(array('name' => 'DOPE'), array('id' => 'DESC'));
print("<table>");
foreach($products as $p)
    print("<tr>" 
            . "<td>" . $p->getId()  . "</td>" 
...
?>
    <form action="" method="GET">
      <label for="name">Product name: </label><br>
      <input type="text" name="name" value="DOPE"><br>
      <input type="submit" value="Submit">
    </form> 
    <hr>
